                                ...
                                foreach ($report_sup as $loaded) { $i=1;?>
                                    ...
                                    <tr>
										...
										<?php if($loaded['STATUS'] == 0 ) { ?>
										    <td>Created&nbsp;&nbsp;
											<a href='<?=base_url()?>user/add_product/<?=$loaded['RECEIPT_PK']?>' >Add Product</a>&nbsp;&nbsp;
											<a href='<?=base_url()?>user/list_products_receipts/<?=$loaded['RECEIPT_PK']?>' >View Products</a>&nbsp;&nbsp;
											<a href='<?=base_url()?>user/finish_receipt/<?=$loaded['RECEIPT_PK']?>' >Finish Receipt</a>&nbsp;&nbsp;
											</td>
										<?php } else{ ?>
											<td>Finished&nbsp;&nbsp;
											
											<a href='<?=base_url()?>user/list_products_receipts/<?=$loaded['RECEIPT_PK']?>' >View Products</a>&nbsp;&nbsp;
											<a target="_blank" href='<?=base_url()?>user/print_receipt/<?=$loaded['RECEIPT_PK']?>' >Print Receipt</a>&nbsp;&nbsp;
											</td>
										<?php } ?>
                                    </tr>
                                    <?php
